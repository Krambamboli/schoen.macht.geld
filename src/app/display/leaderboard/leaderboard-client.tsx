 ...
 * in an alphabetized list. The page is designed to show all stocks at once
 * without scrolling.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 h-full">
            {sortedStocks.map((stock) => {
              ...
              return (
                <div
                  key={stock.id}
                  className="grid grid-cols-[1fr_100px_100px] items-center gap-3 p-2 rounded-lg bg-gray-900/50 border border-gray-800 text-base"
                >
